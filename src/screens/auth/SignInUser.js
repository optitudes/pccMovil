            ...
            <Box flex="1" backgroundColor="#26b99a">
                ...
                <HStack justifyContent="space-between" mb="5" alignItems="flex-start" pt="3">
                    ...
                    <Box flexDirection="column" alignItems="flex-start" pl="3" flex="1" ml="1">
                        <Text fontSize="xl" fontWeight="bold" color="gray.100" >Registro de usuario</Text>
                    </Box>
                    ...
                    <Box px={"4"}>
                            ...
                            <MATextInput
                                ...
                                onBlur={(event) => {
                                    if (data.name === "" || data.name.length > 20 ) {
                                        setErrorInput("Debe ingresar un nombre válido")
                                    } else {
                                        setErrorInput(null)
                                    }
                                }}
                        ...
                        <FormControl mt="5">
                            <MATextInput
                                ...
                                onChangeText={(event) => { 
                                    setData({ ...data, password: event })
                                     }}
                                onBlur={(event) => {
                                    if (data.password === "" || data.password.length > 30 ) {
                                        setErrorInput("Debe ingresar una contraseña")
                                    } else {
                                        setErrorInput(null)
                                    }
                                }}
