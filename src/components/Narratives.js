...
const Narratives = (props) => {
    ...
    useEffect(() => {
        const updateAppInfo = async () => {
            try {
                let info = [];
                info.push({title:"",content:"Narrativa: 3.TS.3. (2022). Paisaje cultural cafetero, es el desarrollo de una cultura desde unos pilares identitarios claros que giran en torno al café, su producción y como las personas crecen y se desenvuelven en estos ambientes, creando un patrimonio con una riqueza histórica, natural, cultural, única de la región cafetera de Colombia como es el Quindío, y se considera único por la ubicación geográfica, su clima, y toda la cultura que se construyó en esta zona."})
                info.push({title:"",content:"LCNYEA 2: (2022) A mi se me viene a la mente por paisaje cultural cafetero a los paisajes que caracterizan a la zona cafetera, paisajes que son únicos. Montañas, clima templado, grandes sectores con plantas de café, de plátano, entre otras. Yo creo que el paisaje cafetero se caracteriza por su verde, por sus montañas verdes, por los terrenos llenos de plantas de café, por el café."})
                info.push({title:"",content:"CSP.3 (2022):  la geografía de los pueblos, su economía también va los conocimientos, los saberes generacionales, los icónicos del trabajador cafetero, el turismo desmedido, las artesanías alrededor del café."})
    ...
    return (<Box marginX="5"
        ...
        alignItems="center"
    >
            <Text fontSize={"xl"} color={colors.PRIMARY1} fontWeight={"semibold"} >Narrativas de los estudiantes</Text>
        <Carousel
            ref={carouselRef}
            data={infoList}
